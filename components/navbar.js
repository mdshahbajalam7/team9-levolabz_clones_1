...
export default function Navbar() {
  ...
  return (
    <div className="p-4 top-0 sticky bg-white scroll drop-shadow-sm z-50">
    <div className="lg:w-[85%] mx-[auto] md:lg:w-[95%] smlg:w-[98%] sm:mx-[auto]">
        ...
        <div className="absolute bg-white w-full overflow-y-scroll">
          ...
          <div className="px-3 mt-5">
            ...
            <p className="flex items-center justify-between py-3 border-b border-gray-300 font-semibold text-gray-500">
              AI Services <ChevronRightIcon className="w-5 h-5 fill-blue-500" />
            </p>
            <p className="flex items-center justify-between py-3 border-b border-gray-300 font-semibold text-gray-500">
              Cloud Services
